{-- | BIP39 English wordlist filtered to words of 7 characters or fewer,
 - so a generated @"word_word_NNN"@ username always fits the existing
 - 3-20 character username limit (7+1+7+1+3 = 19 max).
 -
 - 1960 of the standard 2048 BIP39 words.  Kept in sync with the
...
-- | The BIP39 word list (≤7 chars each), as a 'Vector' for O(1)
-- index access.
bip39Words :: Vector Text
bip39Words = V.fromList bip39WordList

-- | Generates a @"word_word_NNN"@ 'DisplayName' from two distinct
-- BIP39 words plus a random 3-digit number.
--
-- Example: @"brave_tiger_482"@.
generateBIP39Username :: IO DisplayName
generateBIP39Username = do
  let len = V.length bip39Words
  idx1 <- randomRIO (0, len - 1)
  idx2 <- pickDistinct len idx1
  num  <- randomRIO (0 :: Int, 999)
  let w1     = bip39Words V.! idx1
      w2     = bip39Words V.! idx2
      numTxt = T.justifyRight 3 '0' (T.pack (show num))
      name   = w1 <> "_" <> w2 <> "_" <> numTxt
  return $! verifyDisplayName name
  where
    pickDistinct :: Int -> Int -> IO Int
...
bip39WordList :: [Text]
bip39WordList =
  [ "abandon", "ability", "able", "about", "above", "absent", "absorb", "absurd", "abuse", "access"
  , "account", "accuse", "achieve", "acid", "acquire", "across", "act", "action", "actor", "actress"
  ...
  , "armed", "armor", "army", "around", "arrange", "arrest", "arrive", "arrow", "art", "artist"
  , "artwork", "ask", "aspect", "assault", "asset", "assist", "assume", "asthma", "athlete", "atom"
  , "attack", "attend", "attract", "auction", "audit", "august", "aunt", "author", "auto", "autumn"
  , "average", "avocado", "avoid", "awake", "aware", "away", "awesome", "awful", "awkward", "axis"
  , "baby", "bacon", "badge", "bag", "balance", "balcony", "ball", "bamboo", "banana", "banner"
  ...
  , "board", "boat", "body", "boil", "bomb", "bone", "bonus", "book", "boost", "border", "boring"
  ...
  , "bulb", "bulk", "bullet", "bundle", "bunker", "burden", "burger", "burst", "bus", "busy"
  ...
  , "case", "cash", "casino", "castle", "casual", "cat", "catalog", "catch", "cattle", "caught"
  , "cause", "caution", "cave", "ceiling", "celery", "cement", "census", "century", "cereal"
  , "certain", "chair", "chalk", "change", "chaos", "chapter", "charge", "chase", "chat", "cheap"
  , "check", "cheese", "chef", "cherry", "chest", "chicken", "chief", "child", "chimney", "choice"
  , "choose", "chronic", "chuckle", "chunk", "churn", "cigar", "circle", "citizen", "city", "civil"
  ...
  , "concert", "conduct", "confirm", "connect", "control", "cook", "cool", "copper", "copy", "coral"
  ...
  , "crystal", "cube", "culture", "cup", "curious", "current", "curtain", "curve", "cushion"
  , "custom", "cute", "cycle", "dad", "damage", "damp", "dance", "danger", "daring", "dash", "dawn"
  , "day", "deal", "debate", "debris", "decade", "decide", "decline", "deer", "defense", "define"
  , "defy", "degree", "delay", "deliver", "demand", "demise", "denial", "dentist", "deny", "depart"
  , "depend", "deposit", "depth", "deputy", "derive", "desert", "design", "desk", "despair"
  , "destroy", "detail", "detect", "develop", "device", "devote", "diagram", "dial", "diamond"
  , "diary", "dice", "diesel", "diet", "differ", "digital", "dignity", "dilemma", "dinner", "direct"
  , "dirt", "disease", "dish", "dismiss", "display", "divert", "divide", "divorce", "dizzy"
  , "doctor", "dog", "doll", "dolphin", "domain", "donate", "donkey", "donor", "door", "dose"
  ...
  , "egg", "eight", "either", "elbow", "elder", "elegant", "element", "elite", "else", "embark"
  ...
  , "enlist", "enough", "enrich", "enroll", "ensure", "enter", "entire", "entry", "episode", "equal"
  , "equip", "era", "erase", "erode", "erosion", "error", "erupt", "escape", "essay", "essence"
  , "estate", "eternal", "ethics", "evil", "evoke", "evolve", "exact", "example", "excess", "excite"
  , "exclude", "excuse", "execute", "exhaust", "exhibit", "exile", "exist", "exit", "exotic"
  , "expand", "expect", "expire", "explain", "expose", "express", "extend", "extra", "eye"
  , "eyebrow", "fabric", "face", "faculty", "fade", "faint", "faith", "fall", "false", "fame"
  , "family", "famous", "fan", "fancy", "fantasy", "farm", "fashion", "fat", "fatal", "father"
  , "fatigue", "fault", "feature", "federal", "fee", "feed", "feel", "female", "fence", "fetch"
  ...
  , "found", "fox", "fragile", "frame", "fresh", "friend", "fringe", "frog", "front", "frost"
  ...
  , "heavy", "height", "hello", "helmet", "help", "hen", "hero", "hidden", "high", "hill", "hint"
  , "hip", "hire", "history", "hobby", "hockey", "hold", "hole", "holiday", "hollow", "home"
  , "honey", "hood", "hope", "horn", "horror", "horse", "host", "hotel", "hour", "hover", "hub"
  , "huge", "human", "humble", "humor", "hundred", "hungry", "hunt", "hurdle", "hurry", "hurt"
  , "husband", "hybrid", "ice", "icon", "idea", "idle", "ignore", "ill", "illegal", "illness"
  , "image", "imitate", "immense", "immune", "impact", "impose", "improve", "impulse", "inch"
  , "include", "income", "index", "indoor", "infant", "inflict", "inform", "inhale", "inherit"
  , "initial", "inject", "injury", "inmate", "inner", "input", "inquiry", "insane", "insect"
  , "inside", "inspire", "install", "intact", "into", "invest", "invite", "involve", "iron"
  ...
  , "jungle", "junior", "junk", "just", "keen", "keep", "ketchup", "key", "kick", "kid", "kidney"
  , "kind", "kingdom", "kiss", "kit", "kitchen", "kite", "kitten", "kiwi", "knee", "knife", "knock"
  , "know", "lab", "label", "labor", "ladder", "lady", "lake", "lamp", "laptop", "large", "later"
  ...
  , "maple", "marble", "march", "margin", "marine", "market", "mask", "mass", "master", "match"
  , "math", "matrix", "matter", "maximum", "maze", "meadow", "mean", "measure", "meat", "medal"
  , "media", "melody", "melt", "member", "memory", "mention", "menu", "mercy", "merge", "merit"
  , "merry", "mesh", "message", "metal", "method", "middle", "milk", "million", "mimic", "mind"
  , "minimum", "minor", "minute", "miracle", "mirror", "misery", "miss", "mistake", "mix", "mixed"
  , "mixture", "mobile", "model", "modify", "mom", "moment", "monitor", "monkey", "monster", "month"
  , "moon", "moral", "more", "morning", "mother", "motion", "motor", "mouse", "move", "movie"
  , "much", "muffin", "mule", "muscle", "museum", "music", "must", "mutual", "myself", "mystery"
  ...
  , "orange", "orbit", "orchard", "order", "organ", "orient", "orphan", "ostrich", "other"
  ...
  , "phone", "photo", "phrase", "piano", "picnic", "picture", "piece", "pig", "pigeon", "pill"
  ...
  , "pole", "police", "pond", "pony", "pool", "popular", "portion", "post", "potato", "pottery"
  , "poverty", "powder", "power", "praise", "predict", "prefer", "prepare", "present", "pretty"
  , "prevent", "price", "pride", "primary", "print", "prison", "private", "prize", "problem"
  , "process", "produce", "profit", "program", "project", "promote", "proof", "prosper", "protect"
  , "proud", "provide", "public", "pudding", "pull", "pulp", "pulse", "pumpkin", "punch", "pupil"
  , "puppy", "purity", "purpose", "purse", "push", "put", "puzzle", "pyramid", "quality", "quantum"
  , "quarter", "quick", "quit", "quiz", "quote", "rabbit", "raccoon", "race", "rack", "radar"
  ...
  , "require", "rescue", "resist", "result", "retire", "retreat", "return", "reunion", "reveal"
  ...
  , "scatter", "scene", "scheme", "school", "science", "scout", "scrap", "screen", "script", "scrub"
  , "sea", "search", "season", "seat", "second", "secret", "section", "seed", "seek", "segment"
  , "select", "sell", "seminar", "senior", "sense", "series", "service", "session", "settle"
  , "setup", "seven", "shadow", "shaft", "shallow", "share", "shed", "shell", "sheriff", "shield"
  , "shift", "shine", "ship", "shiver", "shock", "shoe", "shoot", "shop", "short", "shove", "shrimp"
  ...
  , "social", "sock", "soda", "soft", "solar", "soldier", "solid", "solve", "someone", "song"
  ...
  , "spring", "spy", "square", "squeeze", "stable", "stadium", "staff", "stage", "stairs", "stamp"
  , "stand", "start", "state", "stay", "steak", "steel", "stem", "step", "stereo", "stick", "still"
  , "sting", "stock", "stomach", "stone", "stool", "story", "stove", "street", "strike", "strong"
  ...
  , "supply", "supreme", "sure", "surface", "surge", "survey", "suspect", "sustain", "swallow"
  ...
  , "toast", "tobacco", "today", "toddler", "toe", "toilet", "token", "tomato", "tone", "tongue"
  , "tonight", "tool", "tooth", "top", "topic", "topple", "torch", "tornado", "toss", "total"
  , "tourist", "toward", "tower", "town", "toy", "track", "trade", "traffic", "tragic", "train"
  , "trap", "trash", "travel", "tray", "treat", "tree", "trend", "trial", "tribe", "trick"
  , "trigger", "trim", "trip", "trophy", "trouble", "truck", "true", "truly", "trumpet", "trust"
  , "truth", "try", "tube", "tuition", "tumble", "tuna", "tunnel", "turkey", "turn", "turtle"
  , "twelve", "twenty", "twice", "twin", "twist", "two", "type", "typical", "ugly", "unable"
  , "unaware", "uncle", "uncover", "under", "undo", "unfair", "unfold", "unhappy", "uniform"
  , "unique", "unit", "unknown", "unlock", "until", "unusual", "unveil", "update", "upgrade"
  ...
  , "wagon", "wait", "walk", "wall", "walnut", "want", "warfare", "warm", "warrior", "wash", "wasp"
