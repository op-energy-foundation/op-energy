...
-- filtered to words of at most 7 characters, so that a generated
-- \"word_word_NNN\" display name is at most 19 characters (7+1+7+1+3) and
-- stays well inside the 255 character limit everifyDisplayName imposes.
-- 1960 of the standard 2048 words.
--
-- Used by 'OpEnergy.Account.Server.V1.AccountService.register' to give a new
-- person a name they can actually remember and repeat, rather than a slice of
-- their UUID.
...
bip39Words =
  ...
  , "access", "account", "accuse", "achieve", "acid", "acquire", "across", "act", "action"
  ...
  , "ancient", "anger", "angle", "angry", "animal", "ankle", "annual", "another", "answer"
  , "antenna", "antique", "anxiety", "any", "apart", "apology", "appear", "apple", "approve"
  , "april", "arch", "arctic", "area", "arena", "argue", "arm", "armed", "armor", "army"
  , "around", "arrange", "arrest", "arrive", "arrow", "art", "artist", "artwork", "ask"
  ...
  , "axis", "baby", "bacon", "badge", "bag", "balance", "balcony", "ball", "bamboo", "banana"
  ...
  , "blade", "blame", "blanket", "blast", "bleak", "bless", "blind", "blood", "blossom"
  ...
  , "bright", "bring", "brisk", "broken", "bronze", "broom", "brother", "brown", "brush"
  , "bubble", "buddy", "budget", "buffalo", "build", "bulb", "bulk", "bullet", "bundle"
  , "bunker", "burden", "burger", "burst", "bus", "busy", "butter", "buyer", "buzz", "cabbage"
  ...
  , "castle", "casual", "cat", "catalog", "catch", "cattle", "caught", "cause", "caution"
  , "cave", "ceiling", "celery", "cement", "census", "century", "cereal", "certain", "chair"
  , "chalk", "change", "chaos", "chapter", "charge", "chase", "chat", "cheap", "check", "cheese"
  , "chef", "cherry", "chest", "chicken", "chief", "child", "chimney", "choice", "choose"
  , "chronic", "chuckle", "chunk", "churn", "cigar", "circle", "citizen", "city", "civil"
  ...
  , "company", "concert", "conduct", "confirm", "connect", "control", "cook", "cool", "copper"
  ...
  , "crunch", "crush", "cry", "crystal", "cube", "culture", "cup", "curious", "current"
  , "curtain", "curve", "cushion", "custom", "cute", "cycle", "dad", "damage", "damp", "dance"
  , "danger", "daring", "dash", "dawn", "day", "deal", "debate", "debris", "decade", "decide"
  ...
  , "derive", "desert", "design", "desk", "despair", "destroy", "detail", "detect", "develop"
  , "device", "devote", "diagram", "dial", "diamond", "diary", "dice", "diesel", "diet"
  , "differ", "digital", "dignity", "dilemma", "dinner", "direct", "dirt", "disease", "dish"
  , "dismiss", "display", "divert", "divide", "divorce", "dizzy", "doctor", "dog", "doll"
  ...
  , "elbow", "elder", "elegant", "element", "elite", "else", "embark", "embody", "embrace"
  ...
  , "enough", "enrich", "enroll", "ensure", "enter", "entire", "entry", "episode", "equal"
  , "equip", "era", "erase", "erode", "erosion", "error", "erupt", "escape", "essay", "essence"
  , "estate", "eternal", "ethics", "evil", "evoke", "evolve", "exact", "example", "excess"
  , "excite", "exclude", "excuse", "execute", "exhaust", "exhibit", "exile", "exist", "exit"
  ...
  , "father", "fatigue", "fault", "feature", "federal", "fee", "feed", "feel", "female", "fence"
  ...
  , "forum", "forward", "fossil", "foster", "found", "fox", "fragile", "frame", "fresh"
  ...
  , "height", "hello", "helmet", "help", "hen", "hero", "hidden", "high", "hill", "hint", "hip"
  , "hire", "history", "hobby", "hockey", "hold", "hole", "holiday", "hollow", "home", "honey"
  , "hood", "hope", "horn", "horror", "horse", "host", "hotel", "hour", "hover", "hub", "huge"
  ...
  , "jungle", "junior", "junk", "just", "keen", "keep", "ketchup", "key", "kick", "kid"
  ...
  , "margin", "marine", "market", "mask", "mass", "master", "match", "math", "matrix", "matter"
  , "maximum", "maze", "meadow", "mean", "measure", "meat", "medal", "media", "melody", "melt"
  , "member", "memory", "mention", "menu", "mercy", "merge", "merit", "merry", "mesh", "message"
  , "metal", "method", "middle", "milk", "million", "mimic", "mind", "minimum", "minor"
  , "minute", "miracle", "mirror", "misery", "miss", "mistake", "mix", "mixed", "mixture"
  , "mobile", "model", "modify", "mom", "moment", "monitor", "monkey", "monster", "month"
  ...
  , "need", "neglect", "neither", "nephew", "nerve", "nest", "net", "network", "neutral"
  ...
  , "opinion", "oppose", "option", "orange", "orbit", "orchard", "order", "organ", "orient"
  ...
  , "pond", "pony", "pool", "popular", "portion", "post", "potato", "pottery", "poverty"
  , "powder", "power", "praise", "predict", "prefer", "prepare", "present", "pretty", "prevent"
  , "price", "pride", "primary", "print", "prison", "private", "prize", "problem", "process"
  , "produce", "profit", "program", "project", "promote", "proof", "prosper", "protect", "proud"
  , "provide", "public", "pudding", "pull", "pulp", "pulse", "pumpkin", "punch", "pupil"
  , "puppy", "purity", "purpose", "purse", "push", "put", "puzzle", "pyramid", "quality"
  , "quantum", "quarter", "quick", "quit", "quiz", "quote", "rabbit", "raccoon", "race", "rack"
  ...
  , "rely", "remain", "remind", "remove", "render", "renew", "rent", "reopen", "repair"
  , "repeat", "replace", "report", "require", "rescue", "resist", "result", "retire", "retreat"
  ...
  , "science", "scout", "scrap", "screen", "script", "scrub", "sea", "search", "season", "seat"
  , "second", "secret", "section", "seed", "seek", "segment", "select", "sell", "seminar"
  , "senior", "sense", "series", "service", "session", "settle", "setup", "seven", "shadow"
  , "shaft", "shallow", "share", "shed", "shell", "sheriff", "shield", "shift", "shine", "ship"
  , "shiver", "shock", "shoe", "shoot", "shop", "short", "shove", "shrimp", "shrug", "shuffle"
  ...
  , "soccer", "social", "sock", "soda", "soft", "solar", "soldier", "solid", "solve", "someone"
  ...
  , "surge", "survey", "suspect", "sustain", "swallow", "swamp", "swap", "swarm", "swear"
  ...
  , "today", "toddler", "toe", "toilet", "token", "tomato", "tone", "tongue", "tonight", "tool"
  , "tooth", "top", "topic", "topple", "torch", "tornado", "toss", "total", "tourist", "toward"
  , "tower", "town", "toy", "track", "trade", "traffic", "tragic", "train", "trap", "trash"
  ...
  , "twenty", "twice", "twin", "twist", "two", "type", "typical", "ugly", "unable", "unaware"
  , "uncle", "uncover", "under", "undo", "unfair", "unfold", "unhappy", "uniform", "unique"
  , "unit", "unknown", "unlock", "until", "unusual", "unveil", "update", "upgrade", "uphold"
  , "upon", "upper", "upset", "urban", "urge", "usage", "use", "used", "useful", "useless"
  , "usual", "utility", "vacant", "vacuum", "vague", "valid", "valley", "valve", "van", "vanish"
  , "vapor", "various", "vast", "vault", "vehicle", "velvet", "vendor", "venture", "venue"
