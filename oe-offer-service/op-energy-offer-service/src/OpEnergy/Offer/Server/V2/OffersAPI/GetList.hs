{-- | GET /api/v2/offer/list -- public, unauthenticated listing across every
 - account, optionally filtered by status/creatorDisplayName, paginated.
 - No pre-existing pagination convention exists elsewhere in this service
 - to match (checked) -- see Data.OpEnergy.Offer.API.V2.OffersAPI.PaginatedOffers
 - for the from-scratch shape.
 -}
